 ...
 *  \copydetails Group_BoardInfo_ARDUINO_MICRO
 *
 ...
 *  \defgroup Group_BoardInfo_ARDUINO_MICRO ARDUINO_MICRO
 *  \brief Board specific information header for the Arduino Micro board.
 *
 *  Board specific information header for the Arduino Micro board (http://arduino.cc/de/Main/ArduinoBoardMicro).
 *
 *  @{
 */

#ifndef __BOARD_ARDUINO_MICRO_H__
#define __BOARD_ARDUINO_MICRO_H__
